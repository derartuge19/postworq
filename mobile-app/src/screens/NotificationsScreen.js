...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, fontWeight: '700', color: '#F9E08B' },
  filterBar: { paddingHorizontal: 16, gap: 6 },
  filterChip: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  activeChip: { backgroundColor: '#F9E08B' },
  filterLabel: { fontSize: 12, fontWeight: '600', color: '#F9E08B' },
  activeLabel: { color: '#000' },
  list: { paddingBottom: 100, paddingHorizontal: 0 },
  notifItem: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 16,
  ...
  unreadItem: { backgroundColor: '#F9E08B0a', borderLeftWidth: 3, borderLeftColor: '#F9E08B' },
