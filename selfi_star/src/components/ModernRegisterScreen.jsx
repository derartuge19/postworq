  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <img src={ethioLogo} alt="Ethio Telecom" style={{ width: 60, height: 60, objectFit: "contain" }} />
      </div>
      <div style={{
        position: "absolute",
        top: 20,
        ...
        <img src={flipLogo} alt="FlipStar" style={{ width: 60, height: 60, objectFit: "contain" }} />
      </div>
