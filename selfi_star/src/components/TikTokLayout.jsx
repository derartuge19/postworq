...
export function TikTokLayout({ user, activeTab: propActiveTab, onLogout, onRequireAuth, onShowPostPage, onShowProfile, onShowSettings, onShowCampaigns }) {
        ...
        {activeTab === "inbox" ? (
          ...
          <div style={{ width: "100%", maxWidth: 600, display: "flex", flexDirection: "column", gap: 20, padding: "0 20px" }}>
            ...
            >
              ...
              {video.imageUrl ? (
                video.imageUrl.match(/\.(mp4|webm|ogg|mov)$/i) || video.imageUrl.includes('video') ? (
                  <div 
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
                  ...
                  {user && video.user?.id && video.creator !== user.username && (
                    <button
                      ...
                      style={{
                        padding: "8px 20px",
                        border: followingUsers[video.user.id] ? "1px solid rgba(255,255,255,0.4)" : "none",
                        background: followingUsers[video.user.id] ? "rgba(255,255,255,0.15)" : T.pri,
                        borderRadius: 8,
                        cursor: "pointer",
                        fontSize: 13,
                        fontWeight: 700,
                        ...
                        gap: 6,
                        transition: "all 0.2s",
                        boxShadow: followingUsers[video.user.id] ? "none" : "0 2px 8px rgba(218, 155, 42, 0.4)",
                      }}
                      onMouseEnter={(e) => {
                        if (!followingUsers[video.user.id]) {
                          e.currentTarget.style.transform = "scale(1.05)";
                          e.currentTarget.style.boxShadow = "0 4px 12px rgba(218, 155, 42, 0.6)";
                        }
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.transform = "scale(1)";
                        e.currentTarget.style.boxShadow = followingUsers[video.user.id] ? "none" : "0 2px 8px rgba(218, 155, 42, 0.4)";
                      }}
                    >
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  >
                    <Bookmark size={28} strokeWidth={2} fill={video.saved ? T.pri : "none"} />
                  </button>
                  <div style={{ fontSize: 12, fontWeight: 700, color: "#fff", textAlign: "center" }}>
